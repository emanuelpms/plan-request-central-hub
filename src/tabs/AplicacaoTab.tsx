...
import { FileText, User, Building, Phone, Mail, MapPin } from 'lucide-react';
...
const AplicacaoTab: React.FC = () => {
  ...
  const validateForm = (): boolean => {
    if (!formData.motivo || !formData.razaoSocial || !formData.cpfCnpj || !formData.telefone1 || !formData.email) {
      toast({
  ...
  const handleSend = () => {
    ...
    toast({
      title: "Enviado!",
      description: "Solicitação de aplicação enviada com sucesso.",
    });
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-purple-50 to-indigo-50 p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        {/* Header */}
        <Card className="bg-gradient-to-r from-purple-600 to-purple-700 border-0 shadow-xl text-white">
          <CardHeader>
            ...
            <Card className="bg-white/90 backdrop-blur-sm border-0 shadow-lg">
              <CardHeader className="bg-gradient-to-r from-purple-600 to-purple-700 text-white rounded-t-lg">
                <div className="flex items-center gap-3">
                  ...
                  <CardTitle className="text-lg">DADOS DA APLICAÇÃO</CardTitle>
                </div>
              </CardHeader>
